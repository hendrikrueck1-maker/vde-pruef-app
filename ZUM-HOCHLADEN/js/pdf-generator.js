    ...
    <div class="sub-section">
      ...
      <div class="grid">
        ...
        <div class="form-group">
          ...
          <input type="text" inputmode="decimal" class="c-zs" value="${data.zs || ''}" placeholder="z. B. 0.38" oninput="onZsInput(${cardCounter})">
          <div class="limit-hint" id="zs_limit_${cardCounter}"></div>
        </div>
        <div class="form-group">
          <label>I<sub>K</sub> (A) [min. siehe Platzhalter]:</label>
          <input type="text" inputmode="decimal" class="c-ik" value="${data.ik || ''}" placeholder="z. B. 605" oninput="onIkInput(${cardCounter})">
        ...
        <div class="form-group">
          ...
          <input type="text" inputmode="decimal" class="c-zln" value="${data.zln || ''}" placeholder="nur wenn gemessen" oninput="onZlnInput(${cardCounter})">
        ...
        <div class="form-group">
          ...
          <input type="text" inputmode="decimal" class="c-ik2" value="${data.ik2 || ''}" placeholder="rechnet sich aus Z_L-N">
        </div>
      </div>
    </div>
...
/* Z_S -> I_K UND Z_L-N -> I_K2 AUTOMATISCH RECHNEN
 * Der berechnete Wert wird mit data-auto markiert. Sobald der Pruefer selbst
 * etwas eintraegt, faellt die Markierung weg und wird nicht mehr ueberschrieben -
 * ein vom Messgeraet abgelesener Wert hat immer Vorrang vor der Rechnung. */
...
function validateNetzmessung() {
  ...
  if (el.value.trim() !== '' && !isNaN(num) && num > U_NPE_SCHWELLE) el.classList.add('out-of-norm');
...
function generatePDF(isBlank = false) {
  ...
  if (isBlank || netzZeile) {
    drawFeldZeile(doc, "Netzmessung (Sollwerte 230 V / 400 V / N-PE 0 V):", netzZeile, spL, z1(6), 184, isBlank);
  }
